      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-text-muted mb-8">
              <li className="flex items-center gap-3">
                ...
                <a href="" className="hover:text-cobalt transition-colors">info@skyvo.in</a>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-cobalt">
                ...
                <a href="https://wa.me/919827744484" target="_blank" rel="noopener noreferrer" className="hover:text-cobalt transition-colors">+91 9827744484</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © 2026 Skyvo Technologies. All rights reserved.
          </p>
